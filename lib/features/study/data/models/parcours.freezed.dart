...
@override
String toString() {
  return 'Parcours(id: $id, titleFr: $titleFr, titleAr: $titleAr, descriptionFr: $descriptionFr, nameNumbers: $nameNumbers, colorHex: $colorHex)';
}
...
/// @nodoc
abstract mixin class $ParcoursCopyWith<$Res>  {
  factory $ParcoursCopyWith(Parcours value, $Res Function(Parcours) _then) = _$ParcoursCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ParcoursCopyWithImpl<$Res>
    implements $ParcoursCopyWith<$Res> {
  _$ParcoursCopyWithImpl(this._self, this._then);

  final Parcours _self;
  final $Res Function(Parcours) _then;
...
/// Adds pattern-matching-related methods to [Parcours].
extension ParcoursPatterns on Parcours {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Parcours value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Parcours() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Parcours value)  $default,){
final _that = this;
switch (_that) {
case _Parcours():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Parcours value)?  $default,){
final _that = this;
switch (_that) {
case _Parcours() when $default != null:
return $default(_that);case _:
...
class _Parcours implements Parcours {
  const _Parcours({required this.id, required this.titleFr, required this.titleAr, required this.descriptionFr, required final  List<int> nameNumbers, required this.colorHex}): _nameNumbers = nameNumbers;
  factory _Parcours.fromJson(Map<String, dynamic> json) => _$ParcoursFromJson(json);
...
@pragma('vm:prefer-inline')
_$ParcoursCopyWith<_Parcours> get copyWith => __$ParcoursCopyWithImpl<_Parcours>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ParcoursToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Parcours&&(identical(other.id, id) || other.id == id)&&(identical(other.titleFr, titleFr) || other.titleFr == titleFr)&&(identical(other.titleAr, titleAr) || other.titleAr == titleAr)&&(identical(other.descriptionFr, descriptionFr) || other.descriptionFr == descriptionFr)&&const DeepCollectionEquality().equals(other._nameNumbers, _nameNumbers)&&(identical(other.colorHex, colorHex) || other.colorHex == colorHex));
}
...
/// @nodoc
abstract mixin class _$ParcoursCopyWith<$Res> implements $ParcoursCopyWith<$Res> {
  factory _$ParcoursCopyWith(_Parcours value, $Res Function(_Parcours) _then) = __$ParcoursCopyWithImpl;
@override @useResult
$Res call({
 String id, String titleFr, String titleAr, String descriptionFr, List<int> nameNumbers, String colorHex
});
...
/// @nodoc
class __$ParcoursCopyWithImpl<$Res>
    implements _$ParcoursCopyWith<$Res> {
  __$ParcoursCopyWithImpl(this._self, this._then);

  final _Parcours _self;
  final $Res Function(_Parcours) _then;
