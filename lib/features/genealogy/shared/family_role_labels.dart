...
String familyRoleLabel(BuildContext context, FamilyRole role) {
  ...
  switch (role) {
    case FamilyRole.prophet:
      return l10n.treeRoleProphet;
    case FamilyRole.father:
      return l10n.treeRoleFather;
    case FamilyRole.mother:
      return l10n.treeRoleMother;
    case FamilyRole.paternalAscendant:
      return l10n.treeRolePaternalAncestor;
    case FamilyRole.maternalAscendant:
      return l10n.treeRoleMaternalAncestor;
    case FamilyRole.uncle:
      return l10n.treeRoleUncle;
    case FamilyRole.aunt:
      return l10n.treeRoleAunt;
    case FamilyRole.wife:
      return l10n.treeRoleWife;
    case FamilyRole.child:
      return l10n.treeRoleChild;
    case FamilyRole.grandchild:
      return l10n.treeRoleGrandchild;
    case FamilyRole.cousin:
      return l10n.treeRoleCousin;
    case FamilyRole.traditionalAncestor:
      return l10n.treeRoleTraditionalAncestor;
  }
}
