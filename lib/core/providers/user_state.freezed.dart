...
@override
int get hashCode => Object.hash(runtimeType,theme,textSize,const DeepCollectionEquality().hash(_favorites),const DeepCollectionEquality().hash(_learned),const DeepCollectionEquality().hash(_viewed),const DeepCollectionEquality().hash(_lastSeen),onboardingCompletedAt,dailyNotifHour,quizzesCompleted,totalQuizScore,const DeepCollectionEquality().hash(_favoriteMembers),const DeepCollectionEquality().hash(_viewedMembers),preferredTreeView,const DeepCollectionEquality().hash(_leitnerBoxes),const DeepCollectionEquality().hash(_completedParcours),studyMode,const DeepCollectionEquality().hash(_husnaLearned));
