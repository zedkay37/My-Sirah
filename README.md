...
Application mobile Flutter permettant d'explorer, d'apprendre et de mémoriser les 201 noms du Prophète Muḥammad ﷺ, avec une expérience de lecture approfondie et une gamification douce.

---

## Table des matières

1. [Vision et périmètre V1](#1-vision-et-périmètre-v1)
...
6. [Données — names.json et categories.json](#6-données--namesjson-et-categoriesjson)
...
10. [Écrans implémentés](#10-écrans-implémentés)
11. [Widgets partagés](#11-widgets-partagés)
12. [Système de quiz](#12-système-de-quiz)
13. [Partage d'image](#13-partage-dimage)
14. [Tests widget](#14-tests-widget)
15. [Problèmes connus et blocages](#15-problèmes-connus-et-blocages)
16. [Roadmap V2+](#16-roadmap-v2)

---

## 1. Vision et périmètre V1

**V1 — focalisée exclusivement sur les 201 noms.**

L'application est conçue avec une architecture modulaire pour accueillir de futures features :
...
Chaque feature future s'ajoutera comme un nouveau dossier sous `lib/features/`. Aucune logique spécifique "names" ne se trouve dans `core/`.
...
## 6. Données — names.json et categories.json
...
Chaque branche (home / discover / profile) conserve son état de navigation indépendamment. Naviguer vers un autre onglet et revenir restore exactement l'état précédent.
...
## 15. Problèmes connus et blocages
...
|---------|-----------------|-------|
| Biographie (Sīra) | `lib/features/sira/` | |
| Qualités (Khaṣāʾiṣ) | `lib/features/khasais/` | |
| Descriptions (Shamāʾil) | `lib/features/shammail/` | |
| Hadiths thématiques | `lib/features/hadiths/` | |
| Ṣalawāt et invocations | `lib/features/salawat/` | |
| Notifications | — | Brancher `flutter_local_notifications ^21` dans `setNotifHour()` |
| Langue arabe | `l10n/intl_ar.arb` | Structure l10n déjà en place |
| Langue anglaise | `l10n/intl_en.arb` | |
| Taille de texte | `core/providers/` | Ajouter un `textScaleProvider`, l'appliquer dans `AppTypography` |
...
*Documentation v1.0.0 — 25 avril 2026*
