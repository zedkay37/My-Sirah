...
void main() {
  ...
  group('HomeScreen', () {
    testWidgets('affiche le chargement puis le nom du jour', (tester) async {
      ...
      expect(
        find.textContaining('Remercie quelqu’un aujourd’hui.'),
        findsOneWidget,
      );
      ...
      final rawDate = DateFormat.yMMMMEEEEd('fr').format(DateTime.now());
      final expectedDate = rawDate[0].toUpperCase() + rawDate.substring(1);
